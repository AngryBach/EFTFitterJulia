...
ctGIm_m1p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGIm/dctGIm_m1p5_rb_rw.root")
ctGIm_m0p7_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGIm/dctGIm_m0p7_rb_rw.root")
ctGIm_p0p7_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGIm/dctGIm_p0p7_rb_rw.root")
ctGIm_p1p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGIm/dctGIm_p1p5_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-1.5], ctGIm_m1p5_file.Get(var_name))
    temp.add_template([-0.7], ctGIm_m0p7_file.Get(var_name))
    temp.add_template([0.7], ctGIm_p0p7_file.Get(var_name))
    temp.add_template([1.5], ctGIm_p1p5_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctGIm_werr/'
