...
ctd8_m2p0_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd8/dctd8_m2p0_rb_rw.root")
ctd8_m1p0_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd8/dctd8_m1p0_rb_rw.root")
ctd8_p0p6_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd8/dctd8_p0p6_rb_rw.root")
ctd8_p1p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd8/dctd8_p1p2_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-2.0], ctd8_m2p0_file.Get(var_name))
    temp.add_template([-1], ctd8_m1p0_file.Get(var_name))
    temp.add_template([0.6], ctd8_p0p6_file.Get(var_name))
    temp.add_template([1.2], ctd8_p1p2_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctd8_werr/'
