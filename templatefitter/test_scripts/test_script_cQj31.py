...
cQj31_m0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj31/dcQj31_m0p5_rb_rw.root")
cQj31_m0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj31/dcQj31_m0p4_rb_rw.root")
cQj31_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj31/dcQj31_p0p3_rb_rw.root")
cQj31_p0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj31/dcQj31_p0p5_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.5], cQj31_m0p5_file.Get(var_name))
    temp.add_template([-0.4], cQj31_m0p4_file.Get(var_name))
    temp.add_template([0.3], cQj31_p0p3_file.Get(var_name))
    temp.add_template([0.5], cQj31_p0p5_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQj31_werr/'
