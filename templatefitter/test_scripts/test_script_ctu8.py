...
ctu8_m1p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu8/dctu8_m1p5_rb_rw.root")
ctu8_m0p8_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu8/dctu8_m0p8_rb_rw.root")
ctu8_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu8/dctu8_p0p3_rb_rw.root")
ctu8_p0p8_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu8/dctu8_p0p8_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-1.5], ctu8_m1p5_file.Get(var_name))
    temp.add_template([-0.8], ctu8_m0p8_file.Get(var_name))
    temp.add_template([0.3], ctu8_p0p3_file.Get(var_name))
    temp.add_template([0.8], ctu8_p0p8_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctu8_werr/'
