...
cG_m0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cG/dcG_m0p5_rb_rw.root")
cG_m0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cG/dcG_m0p3_rb_rw.root")
cG_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cG/dcG_p0p3_rb_rw.root")
cG_p0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cG/dcG_p0p5_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.5], cG_m0p5_file.Get(var_name))
    temp.add_template([-0.3], cG_m0p3_file.Get(var_name))
    temp.add_template([0.3], cG_p0p3_file.Get(var_name))
    temp.add_template([0.5], cG_p0p5_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cG_werr/'
