...
ctu1_m0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu1/dctu1_m0p5_rb_rw.root")
ctu1_m0p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu1/dctu1_m0p2_rb_rw.root")
ctu1_p0p1_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu1/dctu1_p0p1_rb_rw.root")
ctu1_p0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctu1/dctu1_p0p4_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.5], ctu1_m0p5_file.Get(var_name))
    temp.add_template([-0.2], ctu1_m0p2_file.Get(var_name))
    temp.add_template([0.1], ctu1_p0p1_file.Get(var_name))
    temp.add_template([0.4], ctu1_p0p4_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctu1_werr/'
