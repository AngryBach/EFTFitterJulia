...
cQj11_m0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj11/dcQj11_m0p5_rb_rw.root")
cQj11_m0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj11/dcQj11_m0p3_rb_rw.root")
cQj11_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj11/dcQj11_p0p3_rb_rw.root")
cQj11_p0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj11/dcQj11_p0p5_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.5], cQj11_m0p5_file.Get(var_name))
    temp.add_template([-0.3], cQj11_m0p3_file.Get(var_name))
    temp.add_template([0.3], cQj11_p0p3_file.Get(var_name))
    temp.add_template([0.5], cQj11_p0p5_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQj11_werr/'
