...
cQj18_m1p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj18/dcQj18_m1p3_rb_rw.root")
cQj18_m0p9_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj18/dcQj18_m0p9_rb_rw.root")
cQj18_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj18/dcQj18_p0p3_rb_rw.root")
cQj18_p0p7_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj18/dcQj18_p0p7_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-1.3], cQj18_m1p3_file.Get(var_name))
    temp.add_template([-0.9], cQj18_m0p9_file.Get(var_name))
    temp.add_template([0.3], cQj18_p0p3_file.Get(var_name))
    temp.add_template([0.7], cQj18_p0p7_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQj18_werr/'
