...
cQu1_m0p7_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu1/dcQu1_m0p7_rb_rw.root")
cQu1_m0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu1/dcQu1_m0p3_rb_rw.root")
cQu1_p0p1_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu1/dcQu1_p0p1_rb_rw.root")
cQu1_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu1/dcQu1_p0p3_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.7], cQu1_m0p7_file.Get(var_name))
    temp.add_template([-0.3], cQu1_m0p3_file.Get(var_name))
    temp.add_template([0.1], cQu1_p0p1_file.Get(var_name))
    temp.add_template([0.3], cQu1_p0p3_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQu1_werr/'
