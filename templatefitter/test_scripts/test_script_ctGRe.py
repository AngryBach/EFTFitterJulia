...
ctGRe_m0p8_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGRe/dctGRe_m0p8_rb_rw.root")
ctGRe_m0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGRe/dctGRe_m0p5_rb_rw.root")
ctGRe_m0p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGRe/dctGRe_m0p2_rb_rw.root")
ctGRe_p0p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctGRe/dctGRe_p0p2_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.8], ctGRe_m0p8_file.Get(var_name))
    temp.add_template([-0.5], ctGRe_m0p5_file.Get(var_name))
    temp.add_template([-0.2], ctGRe_m0p2_file.Get(var_name))
    temp.add_template([0.2], ctGRe_p0p2_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctGRe_werr/'
