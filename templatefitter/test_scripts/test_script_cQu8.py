...
cQu8_m1p9_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu8/dcQu8_m1p9_rb_rw.root")
cQu8_m1p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu8/dcQu8_m1p5_rb_rw.root")
cQu8_m0p1_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu8/dcQu8_m0p1_rb_rw.root")
cQu8_p0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQu8/dcQu8_p0p4_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-1.9], cQu8_m1p9_file.Get(var_name))
    temp.add_template([-1.5], cQu8_m1p5_file.Get(var_name))
    temp.add_template([-0.1], cQu8_m0p1_file.Get(var_name))
    temp.add_template([0.4], cQu8_p0p4_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQu8_werr/'
