...
cQd1_m0p7_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd1/dcQd1_m0p7_rb_rw.root")
cQd1_m0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd1/dcQd1_m0p3_rb_rw.root")
cQd1_p0p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd1/dcQd1_p0p2_rb_rw.root")
cQd1_p0p6_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd1/dcQd1_p0p6_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.7], cQd1_m0p7_file.Get(var_name))
    temp.add_template([-0.3], cQd1_m0p3_file.Get(var_name))
    temp.add_template([0.2], cQd1_p0p2_file.Get(var_name))
    temp.add_template([0.6], cQd1_p0p6_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQd1_werr/'
