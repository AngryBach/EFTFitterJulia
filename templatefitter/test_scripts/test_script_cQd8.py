...
cQd8_m2p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd8/dcQd8_m2p5_rb_rw.root")
cQd8_m1p0_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd8/dcQd8_m1p0_rb_rw.root")
cQd8_p0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd8/dcQd8_p0p4_rb_rw.root")
cQd8_p1p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQd8/dcQd8_p1p3_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-2.5], cQd8_m2p5_file.Get(var_name))
    temp.add_template([-1], cQd8_m1p0_file.Get(var_name))
    temp.add_template([0.4], cQd8_p0p4_file.Get(var_name))
    temp.add_template([1.3], cQd8_p1p3_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQd8_werr/'
