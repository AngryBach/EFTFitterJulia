...
ctj1_m0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctj1/dctj1_m0p4_rb_rw.root")
ctj1_m0p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctj1/dctj1_m0p2_rb_rw.root")
ctj1_p0p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctj1/dctj1_p0p2_rb_rw.root")
ctj1_p0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctj1/dctj1_p0p4_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.4], ctj1_m0p4_file.Get(var_name))
    temp.add_template([-0.2], ctj1_m0p2_file.Get(var_name))
    temp.add_template([0.2], ctj1_p0p2_file.Get(var_name))
    temp.add_template([0.4], ctj1_p0p4_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctj1_werr/'
