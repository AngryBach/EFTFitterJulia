...
cQj38_m1p0_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj38/dcQj38_m1p0_rb_rw.root")
cQj38_m0p4_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj38/dcQj38_m0p4_rb_rw.root")
cQj38_p0p5_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj38/dcQj38_p0p5_rb_rw.root")
cQj38_p1p2_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/cQj38/dcQj38_p1p2_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-1], cQj38_m1p0_file.Get(var_name))
    temp.add_template([-0.4], cQj38_m0p4_file.Get(var_name))
    temp.add_template([0.5], cQj38_p0p5_file.Get(var_name))
    temp.add_template([1.2], cQj38_p1p2_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/cQj38_werr/'
