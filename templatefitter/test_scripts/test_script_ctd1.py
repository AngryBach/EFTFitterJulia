...
ctd1_m0p6_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd1/dctd1_m0p6_rb_rw.root")
ctd1_m0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd1/dctd1_m0p3_rb_rw.root")
ctd1_p0p3_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd1/dctd1_p0p3_rb_rw.root")
ctd1_p0p6_file = ROOT.TFile("/home/shmukher/MyAnalysisX21.2.162/Plots2/dHistograms/dNLO_EFT_nominal/ctd1/dctd1_p0p6_rb_rw.root")
...
for i in range(len(hist_rebin_names)):
    ...
    temp.add_template([-0.6], ctd1_m0p6_file.Get(var_name))
    temp.add_template([-0.3], ctd1_m0p3_file.Get(var_name))
    temp.add_template([0.3], ctd1_p0p3_file.Get(var_name))
    temp.add_template([0.6], ctd1_p0p6_file.Get(var_name))

    temp.fit()
    
    path = '/home/shmukher/EFTFitterJulia/templatefitter/Fits/ctd1_werr/'
